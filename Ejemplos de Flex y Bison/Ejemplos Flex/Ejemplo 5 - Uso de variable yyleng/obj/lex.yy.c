...
char *yytext;
#line 1 "src/Uso_yyleng.l"
#define INITIAL 0
#line 4 "src/Uso_yyleng.l"
#include <stdio.h>
...
case 1:
YY_RULE_SETUP
#line 14 "src/Uso_yyleng.l"
{printf("Encontre la constante entera decimal: %s de longitud %d \n",yytext,yyleng);}
	YY_BREAK
case 2:
YY_RULE_SETUP
#line 15 "src/Uso_yyleng.l"
{printf("Encontre la constante entera octal: %s de longitud %d \n",yytext,yyleng);}
	YY_BREAK
case 3:
YY_RULE_SETUP
#line 16 "src/Uso_yyleng.l"
{printf("Encontre la constante entera hexadecimal: %s de longitud %d \n",yytext,yyleng);}
	YY_BREAK
case 4:
YY_RULE_SETUP
#line 17 "src/Uso_yyleng.l"
{printf("Encontre el identificador: %s de longitud %d \n",yytext,yyleng);}
	YY_BREAK
case 5:
YY_RULE_SETUP
#line 19 "src/Uso_yyleng.l"
ECHO;
	YY_BREAK
#line 640 "obj/lex.yy.c"
